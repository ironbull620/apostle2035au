	...
	spsupport.api = {
		...
		normalFlow: function()
		{
			...
			if (!spsupport.sites.isBlackStage())
			{
				...
				if (testBucket == '2014w20_new_UI_bugfix' || testBucket == '2014w20_new_UI_RC_bugfix' || testBucket == '2014w20_new_RC_UI_AboveFold' || testBucket == '2014w20_new_RC_UI_HoverMoreArrow' || testBucket == '2014w20_new_RC_UI_AdditionalOffer')
				{
